...
export function CardTitle({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return (
    <h3
      className={cn(
        "font-display text-xl leading-tight text-terra dark:text-cume dark:group-hover:text-bruma",
        className,
      )}
      {...props}
    />
...
export function CardDescription({
  ...
  return (
    <p
      className={cn("text-sm text-stone-600 dark:text-stone-300 dark:group-hover:text-stone-200", className)}
      {...props}
    />
  );
}
