      ...
      pointsToShow.forEach((point) => {
        const marker = L.marker([point.lat, point.lng], {
          icon: L.divIcon({
            ...
            html: `<div style="background:#238A44;color:white;width:26px;height:26px;border-radius:50%;display:grid;place-items:center;font-size:11px;font-weight:700;box-shadow:0 8px 18px -8px rgba(0,0,0,.7)">${point.type[0]}</div>`,
          }),
        });
        marker
